            ...
            <div className="rounded-2xl p-8" style={{ background: 'var(--surface-2)', border: '1px solid var(--border)' }}>
              ...
              {sent ? (
                <div className="flex flex-col items-center text-center py-12">
                  ...
                  <button onClick={() => setSent(false)} className="btn btn-outline btn-sm mt-6">Send Another</button>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea required rows={5} className="form-input resize-none" placeholder="Describe your engineering challenge or requirements..."
